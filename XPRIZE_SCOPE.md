...
ShiftSecure protects work opportunities by helping an employer identify a qualified replacement, understand transportation feasibility, maintain human control over consequential decisions, and verify arrival.
...
The current local demo uses SQLite and can call either the Gemini Developer API or Vertex AI when configured. Without credentials it uses a visibly labeled deterministic fallback.
